...
write.table(beta_inf, "beta_asthma_fixed_inf_values.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_asthma_fixed_grid_values.txt", row.names=FALSE, col.names=FALSE)
