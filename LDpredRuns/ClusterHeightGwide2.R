...
sumstats = readRDS("RefFiles/height.rds")
NCORES=16
...
write.table(beta_inf, "beta_height_inf_values2.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_height_grid_values2.txt", row.names=FALSE, col.names=FALSE)
