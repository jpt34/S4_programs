...
sumstats = readRDS("RefFiles/bmi.rds")
NCORES=16
...
write.table(beta_inf, "beta_bmi_inf_values.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_bmi_grid_values.txt", row.names=FALSE, col.names=FALSE)
