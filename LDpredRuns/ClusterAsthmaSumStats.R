...
sumstats <- fread2("../Asthma/TAGC_Multiancestry_and_European-Ancestry_Meta-analyses_Results.tsv", select = c(1, 3:5, 18:20), col.names = c("chr", "pos", "a0", "a1", "beta", "beta_se", "p"))
...
table(is_bad)
saveRDS(info_snp[!is_bad, ], "RefFiles/asthma.rds")
