...
sumstats = readRDS("RefFiles/endometrial.rds")
NCORES=16
...
write.table(beta_inf, "beta_endometrial_inf_values2.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_endometrial_grid_values2.txt", row.names=FALSE, col.names=FALSE)
