...
write.table(beta_inf, "beta_mdd_inf_values2.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_mdd_grid_values2.txt", row.names=FALSE, col.names=FALSE)
