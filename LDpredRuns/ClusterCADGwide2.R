...
write.table(beta_inf, "beta_cad_inf_values2.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_cad_grid_values2.txt", row.names=FALSE, col.names=FALSE)
