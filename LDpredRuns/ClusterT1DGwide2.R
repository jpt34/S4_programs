...
sumstats = readRDS("RefFiles/t1d.rds")
NCORES=16
...
write.table(beta_inf, "beta_t1d_inf_values2.txt", row.names=FALSE, col.names=FALSE)

(h2_seq <- round(h2_est * c(0.35, 1.4), 4))
...
write.table(beta_grid, "beta_t1d_grid_values2.txt", row.names=FALSE, col.names=FALSE)
