...
sumstats = readRDS("RefFiles/BRCA_onco.rds")
NCORES=16
...
write.table(beta_inf, "beta_inf_values2.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_grid_values2_breast_onco.txt", row.names=FALSE, col.names=FALSE)
