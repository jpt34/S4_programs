...
sumstats <- fread2("../BMI/bmi_all.txt", select = c("Chromosome", "Position", "A1", "A2", "Freq1.Hapmap", "b", "se", "p", "N"),col.names = c("chr", "pos", "a1", "a0", "freq","beta", "beta_se", "p", "n_eff"))
...
table(is_bad)
saveRDS(info_snp[!is_bad, ], "RefFiles/bmi.rds")
