...
beta_grid_tibble=read_delim("beta_endometrial_grid_values2.txt"," ",col_names=FALSE)
...
write.table(pred_grid, "pred_endometrial_grid_values2.txt", row.names=FALSE, col.names=FALSE, sep="\t")
