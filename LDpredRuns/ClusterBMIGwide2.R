...
write.table(beta_inf, "beta_bmi_inf_values2.txt", row.names=FALSE, col.names=FALSE)

(h2_seq <- round(h2_est * c(1.4, 2), 4))
...
write.table(beta_grid, "beta_bmi_grid_values2.txt", row.names=FALSE, col.names=FALSE)
