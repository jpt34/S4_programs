...
write.table(beta_inf, "beta_ibd_inf_values.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_ibd_grid_values.txt", row.names=FALSE, col.names=FALSE)
