...
sumstats = readRDS("RefFiles/mdd.rds")
NCORES=16
...
write.table(beta_inf, "beta_mdd_inf_values.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_mdd_grid_values.txt", row.names=FALSE, col.names=FALSE)
