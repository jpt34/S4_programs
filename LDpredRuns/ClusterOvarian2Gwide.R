...
sumstats = readRDS("RefFiles/ovarian2.rds")
NCORES=16
...
write.table(beta_inf, "beta_ovarian2_inf_values.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_ovarian2_grid_values.txt", row.names=FALSE, col.names=FALSE)
