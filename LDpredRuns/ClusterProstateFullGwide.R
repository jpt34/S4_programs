...
sumstats = readRDS("RefFiles/prostate_full.rds")
NCORES=16
...
write.table(beta_inf, "beta_prostate_full_inf_values.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_prostate_full_grid_values_breast_onco.txt", row.names=FALSE, col.names=FALSE)
