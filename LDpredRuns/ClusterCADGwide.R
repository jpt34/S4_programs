...
sumstats = readRDS("RefFiles/cad.rds")
NCORES=16
...
write.table(beta_inf, "beta_cad_inf_values.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_cad_grid_values.txt", row.names=FALSE, col.names=FALSE)
