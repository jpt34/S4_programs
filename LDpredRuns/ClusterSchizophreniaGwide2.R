...
sumstats = readRDS("RefFiles/schizophrenia.rds")
NCORES=16
...
write.table(beta_inf, "beta_schizophrenia_inf_values2.txt", row.names=FALSE, col.names=FALSE)

(h2_seq <- round(h2_est * c(0.25, 0.35), 4))
...
write.table(beta_grid, "beta_schizophrenia_grid_values2.txt", row.names=FALSE, col.names=FALSE)
