...
write.table(beta_inf, "beta_colorectal_inf_values.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_colorectal_grid_values.txt", row.names=FALSE, col.names=FALSE)
