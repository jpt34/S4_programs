...
write.table(beta_inf, "beta_t1d_inf_values.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_t1d_grid_values.txt", row.names=FALSE, col.names=FALSE)
