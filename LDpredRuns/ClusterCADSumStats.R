...
sumstats <- fread2("../CAD/cad.add.160614.website.txt", select=c("chr","bp_hg19","noneffect_allele","effect_allele", "beta","se_dgc","p_dgc"), col.names = c("chr","pos","a0","a1","beta","beta_se","p"))
...
table(is_bad)
saveRDS(info_snp[!is_bad, ], "RefFiles/cad.rds")
