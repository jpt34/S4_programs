...
write.table(beta_inf, "beta_prostate_inf_values.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_prostate_grid_values_breast_onco.txt", row.names=FALSE, col.names=FALSE)
