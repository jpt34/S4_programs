...
write.table(beta_inf, "beta_endometrial_inf_values.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_endometrial_grid_values.txt", row.names=FALSE, col.names=FALSE)
