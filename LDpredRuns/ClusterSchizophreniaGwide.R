...
write.table(beta_inf, "beta_schizophrenia_inf_values.txt", row.names=FALSE, col.names=FALSE)

(h2_seq <- round(h2_est * c(0.5, 0.7, 1), 4))
...
write.table(beta_grid, "beta_schizophrenia_grid_values.txt", row.names=FALSE, col.names=FALSE)
