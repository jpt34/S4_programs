...
write.table(beta_inf, "beta_diabetes_inf_values.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_diabetes_grid_values.txt", row.names=FALSE, col.names=FALSE)
