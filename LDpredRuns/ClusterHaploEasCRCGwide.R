...
sumstats = readRDS("RefFiles/crc_haplo_eas.rds")
NCORES=16
...
write.table(beta_inf, "beta_crc_haplo_eas_inf_values.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_crc_haplo_eas_grid_values.txt", row.names=FALSE, col.names=FALSE)
