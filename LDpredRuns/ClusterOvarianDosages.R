...
beta_grid_tibble=read_delim("beta_ovarian_grid_values.txt"," ",col_names=FALSE)
...
write.table(pred_grid, "pred_ovarian_grid_values.txt", row.names=FALSE, col.names=FALSE, sep="\t")
