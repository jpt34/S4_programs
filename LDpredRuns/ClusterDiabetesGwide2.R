...
sumstats = readRDS("RefFiles/diabetes.rds")
NCORES=16
...
write.table(beta_inf, "beta_diabetes_inf_values2.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_diabetes_grid_values2.txt", row.names=FALSE, col.names=FALSE)
