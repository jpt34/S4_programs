...
sumstats = readRDS("RefFiles/ovarian.rds")
NCORES=16
...
write.table(beta_inf, "beta_ovarian_inf_values.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_ovarian_grid_values.txt", row.names=FALSE, col.names=FALSE)
