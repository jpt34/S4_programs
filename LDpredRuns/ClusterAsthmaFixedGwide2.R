...
sumstats = readRDS("RefFiles/asthma_fixed.rds")
NCORES=16
...
write.table(beta_inf, "beta_asthma_fixed_inf_values2.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_asthma_fixed_grid_values2.txt", row.names=FALSE, col.names=FALSE)
