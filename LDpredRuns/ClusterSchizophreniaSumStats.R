...
sumstats <- fread2("../Schizophrenia/schizophrenia_all.txt", select=c("CHR","BP","A1","A2","FRQ_U_43456","OR","SE","P","Neff"), col.names=c("chr","pos","a1","a0","freq","beta","beta_se","p","n_eff"))
sumstats$n_eff <- 2*sumstats$n_eff
...
table(is_bad)
saveRDS(info_snp[!is_bad, ], "RefFiles/schizophrenia.rds")
