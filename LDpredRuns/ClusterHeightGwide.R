...
write.table(beta_inf, "beta_height_inf_values.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_height_grid_values.txt", row.names=FALSE, col.names=FALSE)
