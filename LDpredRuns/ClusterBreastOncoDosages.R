...
beta_grid_tibble=read_delim("beta_grid_values_breast_onco.txt"," ",col_names=FALSE)
...
write.table(pred_grid, "pred_grid_values_breast_onco.txt", row.names=FALSE, col.names=FALSE, sep="\t")
