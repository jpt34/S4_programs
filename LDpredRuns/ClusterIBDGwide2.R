...
sumstats = readRDS("RefFiles/ibd.rds")
NCORES=16
...
write.table(beta_inf, "beta_ibd_inf_values2.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_ibd_grid_values2.txt", row.names=FALSE, col.names=FALSE)
