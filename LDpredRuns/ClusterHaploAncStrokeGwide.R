...
sumstats = readRDS("RefFiles/stroke_haplo_anc.rds")
NCORES=16
...
for (chr in 1:22) {
  ...
  corr0 <- readRDS(paste0("RefFiles/haplo_stroke_correlation_chr", chr, ".rds"))[ind.chr3, ind.chr3]
...
write.table(beta_inf, "beta_stroke_haplo_anc_inf_values.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_stroke_haplo_anc_grid_values.txt", row.names=FALSE, col.names=FALSE)
