...
sumstats = readRDS("RefFiles/asthma.rds")
NCORES=16
...
write.table(beta_inf, "beta_asthma_inf_values.txt", row.names=FALSE, col.names=FALSE)
...
write.table(beta_grid, "beta_asthma_grid_values.txt", row.names=FALSE, col.names=FALSE)
